...
import { TestIntroCutsceneWorldTwo } from "../worlds/TestIntroCutsceneWorldTwo"

export const TestIntroCutsceneTwo = ({ onEnd }) => {
  ...
  return <TestIntroCutsceneWorldTwo p1Mesh={p1Mesh} p2Mesh={p2Mesh} />
}
